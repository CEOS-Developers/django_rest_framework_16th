...
![image](https://user-images.githubusercontent.com/68368633/204098164-f37c3661-3151-4204-8193-e3b54a424854.png)
...
#### github secrets 설정
![image](https://user-images.githubusercontent.com/68368633/204098173-5710de6d-801b-4ae2-a40b-2f99be0d5e1d.png)
- ENV_VARS: .env.prod 전체 복사 붙여넣기
- HOST: 배포할 EC2 서버 퍼블릭 DNS(IPv4) 주소
- KEY: 배포할 EC2 서버로 접근 가능한 ssh key 전문 (.pem)

#### push 후 Actions 확인
![image](https://user-images.githubusercontent.com/68368633/204098180-f2f98a13-8658-4c86-a70e-8478fab315a5.png)

![image](https://user-images.githubusercontent.com/68368633/204098198-1ab1a70b-f49f-4e45-b332-92d37770a1bd.png)

<code>deploy.yml</code>에 branch를 master로 설정했기 때문에 master branch에서 push했을 때 자동으로 배포된다.


### 테스트 API 확인
![image](https://user-images.githubusercontent.com/68368633/204098208-31c956b9-73c0-4ad6-a075-1ba6de68a141.png)

postman에서 배포된 EC2 DNS 주소로 접속하여 api 확인

![image](https://user-images.githubusercontent.com/68368633/204098219-1f484a86-7ace-46c3-a9ef-e0fc4f6d47c7.png)
