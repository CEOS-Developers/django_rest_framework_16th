...
과제 제출에 늦었습니다... 밤에 도저히 안되겠어서 자고 일어났더니 갑자기 이것저것 해볼게 떠오르더니 하니까 되네요..? 죄송합니다 반성하겠습니다


1. EC2 띄우기

![](https://velog.velcdn.com/images/bokdol11859/post/83b87dfa-4fc9-432d-9368-7ca3cb22c53f/image.png)


2. RDS 띄우기
![](https://velog.velcdn.com/images/bokdol11859/post/76f20600-78ca-40bc-ab2e-f36c3a0c9520/image.png)



### 도커 파일 설정

많은 분들이 오류를 겪으셨던 RUN pip install --upgrade pip 를 저도 설정을 했습니다

![](https://velog.velcdn.com/images/bokdol11859/post/e63581cd-f1bc-44fb-85f1-497f89f52643/image.png)


아무튼 계속 다 된 것 같은데, 처음에는 400오류가 주구장창 뜨더니, 설정을 조금 고치니까 이번엔 500 에러가 몇시간동안 뜨더라.. 500에서 KO 당하고 취침을 선택했습니다

![](https://velog.velcdn.com/images/bokdol11859/post/a4178885-db99-4918-a3ff-5d634cab0132/image.png)

계속 이렇게 찾아봤다.... 하리보 전시회는 뭐 이런게 있더라구요 하하



그래서 자존심 상한 상태로 일어나서 다시 과제를 하기 시작했는데...


생각을 해보니까 매일같이 하던 makemigrations, migrate를 안했더라구요..?? 아니 어떻게 이걸...

그래서.. 

![](https://velog.velcdn.com/images/bokdol11859/post/23bcf674-4180-4492-8c01-554a75727daa/image.png)

설정을 해줬더니 아니 이런

![](https://velog.velcdn.com/images/bokdol11859/post/617c4027-a50e-47da-b70d-36ff13d21d88/image.png)

바로 됐습니다... 사진은 감격한 상태에서 바로 이것저것 해보다보니까 미개봉 중고 느낌으로다가 이미 설정이 좀 된 스샷이긴 한데, 네.. 됐습니다

이렇게 글로만 보면 금방금방 그래도 해낸거같은데,,, 커밋 내역은 그렇지 않다는 사실.. 고생 조금 했습니다
...
사실 저는 이런 배포 이런걸 되게 좋아합니다... 로컬에서만 되는게 이제 온 동네방네 뿌려질 수 있는 상태로 배포가 되는거니까 되게 설레고 그랬는데,,, 이번엔 살짝 힘들었네요

그래도 성공을 해서 다행이네요

늦어서 죄송합니다. . .

`http://3.38.166.164/v1/signup/`

`http://3.38.166.164/v1/todo_classes/`

`http://3.38.166.164/v1/todos/`

심심하시면 한번쯤 테스트 해보셔도 좋을 것 같아요..! 
